  ...
  return (
    ...
    >
      ...
      <ButtonGroup
        ...
        variant="outline"
        mx="20px"
        borderColor={navbarIcon}
        borderRadius="15px"
      >
        <Button
          onClick={() => toggleLanguage("en")}
          bg={i18n.language === "en" ? "darkblue" : "transparent"}
          color={i18n.language === "en" ? "white" : navbarIcon}
        ...
        <Button
          ...
          bg={i18n.language === "ur" ? "darkblue" : "transparent"}
          color={i18n.language === "ur" ? "white" : navbarIcon}
          _hover={{ bg: "darkblue", color: "white" }}
        >
          اردو
        </Button>
      ...
      <Menu>
        ...
        >
          ...
          <Flex flexDirection="column" p="10px">
            ...
            >
              <Text fontSize="sm">{t("global:profileSettings")}</Text>
            </MenuItem>
            <MenuItem
              _hover={{ bg: "none" }}
              _focus={{ bg: "none" }}
              ...
              onClick={() => logout()}
            >
              <Text fontSize="sm">{t("global:logout")}</Text>
            </MenuItem>
          </Flex>
        </MenuList>
      </Menu>
